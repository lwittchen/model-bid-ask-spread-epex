...
# Modul: Trading Room, Chair for Energy Trading

# Estimating the Bid-Ask Spread with an Trade Indicator Model 
# presented by Madhavan et al. (More Information in the Readme)
...
for(y in years){
  ...
  for(h in hours){
    ...
    dir <- paste("C:/Users/.../",y,"_", h,"_","data_active_hour.txt", sep = "")
